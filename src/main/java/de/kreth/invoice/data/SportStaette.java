...
@Entity
@Table(name = "SPORTSTAETTE")
public class SportStaette extends BaseEntity {
	...
	SportStaette other = (SportStaette) obj;
	return Objects.equals(name, other.name) && userId == other.userId;
    }

    @Override
    public String toString() {
	return "SportStaette [getId()=" + getId() + ", userId=" + userId + ", name=" + name + "]";
    }
